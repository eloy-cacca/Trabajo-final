...
// =======================================================================================
void copy_content_form_16bits_to_8bits(uint16_t *source_16bit, uint16_t *target_8bit, uint16_t length)
{
    uint16_t i = 0;
...
void copy_content_form_8bits_to_16bits(uint16_t *source_8bits, uint16_t *target_16bits, uint16_t length)
{
    uint16_t i = 0;
