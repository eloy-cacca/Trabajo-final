...
#define API_FW_ARM_SEND_COMM_FLAG_REQ             (0x0A)
#define API_FW_ARM_SEND_COMM_FLAG_RES             (0x0B)
...
// ARM - GPIO
#define API_BATTERY_CHANGE_STATE_REQ              (0xB0)
#define API_BATTERY_CHANGE_STATE_RES              (0xB1)
#define API_BATTERY_GET_STATE_REQ                 (0xB2)
#define API_BATTERY_GET_STATE_RES                 (0xB3)
#define API_BOARD_RESET_DSP_REQ                   (0xB4)
#define API_BOARD_RESET_DSP_RES                   (0xB5)
#define API_BOARD_CHANGE_GPIO84_REQ               (0xB6)
#define API_BOARD_CHANGE_GPIO84_RES               (0xB7)
#define API_RPI_5V_EN_CHANGE_REQ                  (0xB8)
#define API_RPI_5V_EN_CHANGE_RES                  (0xB9)
#define API_RPI_ONOFF_CHANGE_REQ                  (0xBA)
#define API_RPI_ONOFF_CHANGE__RES                 (0xBB)
